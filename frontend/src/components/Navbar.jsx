...
export default function Navbar() {
  ...
  const logoText = isTechno ? '#FAF0F2' : '#2A0A12';
  const logoSub  = isTechno ? 'rgba(250,240,242,0.4)' : 'rgba(42,10,18,0.4)';
        ...
        <div className="container" style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: '10px', flexShrink: 0 }}>
            <img
              ...
              style={{ width: '38px', height: '38px', objectFit: 'contain', filter: isTechno ? 'brightness(1.1)' : 'none' }}
              onError={e => {
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }} className="desktop-nav">
            ...
            <div style={{
              ...
              background: isTechno ? 'rgba(255,255,255,0.05)' : 'rgba(107,26,42,0.05)',
